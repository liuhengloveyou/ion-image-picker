...
} var s = e.namespace || "ionimagepicker"; return H || (H = !0, function l(n, t, e) { (n["s-apps"] = n["s-apps"] || []).push(t), e.componentOnReady || (e.componentOnReady = function t() { function e(t) { if (r.nodeName.indexOf("-") > 0) {
...
var c = "$", a = {}, s = { enter: 13, escape: 27, space: 32, tab: 9, left: 37, up: 38, right: 39, down: 40 }, l = function (t, e, r, i) { var o = r.t + c, u = r[o]; if ((2 === r.G || 1 === r.G && !t.Z.Y) && (i["s-sc"] = u ? n(r, i.mode) : n(r)), u) {
    ...
    i = new (o = n.nn(t).$n), function (n, t, e, r, i, o) { n._n.set(r, e), n.On.has(e) || n.On.set(e, {}), Object.entries(Object.assign({ color: { type: String } }, t.properties, { mode: { type: String } })).forEach(function (t) { var u = t[0], f = t[1]; (function (n, t, e, r, i, o, u, f, c) { if (t.type) {
        var a = n.On.get(e);
        !t.attr || void 0 !== a[i] && "" !== a[i] || (f = o && o.Tn) && v(c = f[t.attr]) && (a[i] = S(t.type, c)), e.hasOwnProperty(i) && (void 0 === a[i] && (a[i] = S(t.type, e[i])), "mode" !== i && delete e[i]), r.hasOwnProperty(i) && void 0 === a[i] && (a[i] = r[i]), t.watchCallbacks && (a[P + i] = t.watchCallbacks.slice()), x(r, i, function s(t) { return (t = n.On.get(n._n.get(this))) && t[i]; }, function l(e, r) { (r = n._n.get(this)) && t.mutable && T(n, r, i, e, u); });
    }
    else
        t.method && W(e, i, r[i].bind(r)); })(n, f, e, r, u, i, o); }); }(n, o, t, i, e, r), function u(n, t, e) { if (t) {
        var r = n._n.get(e);
    ...
    t.addEventListener("e", null, Object.defineProperty({}, "passive", { get: function () { return i.Nn = !0; } }));
        ...
        if (!n.Bn(t))
            return 9 !== n.Rn(t);
        t = n.Bn(t);
    } }(n.Z, t) && (n.mn.set(t, !0), L(n, t), j(n.Sn.get(t), !0), n.Z.on(t), n.ct.delete(t), n.l && n.l.removeHost(t), [n.Mn, n.at, n.jn].forEach(function (n) { return n.delete(t); })); })(n, this); }, e["s-init"] = function () { (function (n, t, e, r, i, o) { if (R(n, t) && n.gn.get(t) && !n.mn.has(t) && (!t["s-ld"] || !t["s-ld"].length)) {
        n.ot.set(t, !0), n.st.has(t) || (n.st.set(t, !0), t["s-ld"] = void 0, n.Z.En(t, e));
        try {
            j(n.Sn.get(t)), (o = n.at.get(t)) && (o.forEach(function (n) { return n(t); }), n.at.delete(t));
        }
        catch (e) {
            n.kn(e, 4, t);
        }
